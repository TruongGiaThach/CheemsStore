                    ...
                    <div class="col col-8 product-category">
                        <div class="row">
                            <div class="col col-6 border-right border-bottom">
                                <a href="/store/cate2/MSI" id="banner-interaction">
                                    <h5>MSI Gaming</h5>
                            ...
                            <div class="col col-6 border-left border-bottom">
                                <a href="/store/cate2/HP" id="banner-interaction">
                                    <h5>Lễ hội HP</h5>
                                    <p>Siêu khuyến mãi</p>
                        ...
                        <div class="row">
                            <div class="col col-6 border-right border-top">
                                <a href="/store/cate2/LG" id="banner-interaction">
                                    <h5>LG Gram</h5>
                            ...
                            <div class="col col-6 border-left border-top">
                                <a href="/store/cate2/Lenovo" id="banner-interaction">
                                    <h5>Lenovo</h5>
            ...
            <div class = "col ml-auto">
                ...
                <div class="row">
                    ...
                    <div class="col col-8 product-category">
                        <div class="row">
                            <div class="col col-6 border-right border-bottom">
                                <a href="/store/cate5/PC" id="banner-interaction">
                            ...
                            <div class="col col-6 border-left border-bottom">
                                <a href="/store/cate7/SSD" id="banner-interaction">
                                    <h5>SSD</h5>
                        ...
                        <div class="row">
                            <div class="col col-6 border-right border-top">
                                <a href="/store/cate6" id="banner-interaction">
                            ...
                            <div class="col col-6 border-left border-top">
                                <a href="/store/cate7/RTX" id="banner-interaction">
                                    <h5>RTX 30 Series</h5>
            ...
            <div class = "col mr-auto">
                ...
                <div class="row">
                    ...
                    <div class="col col-8 product-category">
                        <div class="row">
                            <div class="col col-6 border-right border-bottom">
                                <a href="/store/cate3" id="banner-interaction">
                                    <h5>Smart TV</h5>
                            ...
                            <div class="col col-6 border-left border-bottom">
                                <a href="/store/cate1/Tủ lạnh" id="banner-interaction">
                                    <h5>Tủ Lạnh</h5>
                        ...
                        <div class="row">
                            <div class="col col-6 border-right border-top">
                                <a href="/store/cate1/Máy lọc" id="banner-interaction">
                                    <h5>Máy Lọc Khí</h5>
                            ...
                            <div class="col col-6 border-left border-top">
                                <a href="/store/cate1/Máy hút" id="banner-interaction">
            ...
            <div class = "col ml-auto">
                ...
                <div class="row">
                    ...
                    <div class="col col-8 product-category">
                        <div class="row">
                            <div class="col col-6 border-right border-bottom">
                                <a href="/store/cate4/Xiaomi" id="banner-interaction">
                            ...
                            <div class="col col-6 border-left border-bottom">
                                <a href="/store/cate4/tablet" id="banner-interaction">
                                    <h5>Tablet</h5>
                        ...
                        <div class="row">
                            <div class="col col-6 border-right border-top">
                                <a href="/store/cate11" id="banner-interaction">
                                    <h5>Máy Ảnh</h5>
                            ...
                            <div class="col col-6 border-left border-top">
                                <a href="/store/cate4/đồng hồ" id="banner-interaction">
                                    <h5>Smartwatch</h5>
            ...
            <div class = "col mr-auto">
                ...
                <div class="row">
                    ...
                    <div class="col col-8 product-category">
                        <div class="row">
                            <div class="col col-6 border-right border-bottom">
                                <a href="/store/cate8/chuột" id="banner-interaction">
                                    <h5>Chuột Gaming</h5>
                            ...
                            <div class="col col-6 border-left border-bottom">
                                <a href="/store/cate9/tai nghe bluetooth" id="banner-interaction">
                        ...
                        <div class="row">
                            <div class="col col-6 border-right border-top">
                                <a href="/store/cate7/ổ cứng" id="banner-interaction">
                            ...
                            <div class="col col-6 border-left border-top">
                                <a href="/store/cate8/bàn phím" id="banner-interaction">
            ...
            <div class = "col ml-auto">
                ...
                <div class="row">
                    ...
                    <div class="col col-8 product-category">
                        <div class="row">
                            <div class="col col-6 border-right border-bottom">
                                <a href="/store/cate5/văn phòng" id="banner-interaction">
                                    <h5>PC Văn Phòng</h5>
                            ...
                            <div class="col col-6 border-left border-bottom">
                                <a href="/store/cate12/máy in" id="banner-interaction">
                                    <h5>Combo Máy In</h5>
                        ...
                        <div class="row">
                            <div class="col col-6 border-right border-top">
                                <a href="/store/cate14" id="banner-interaction">
                            ...
                            <div class="col col-6 border-left border-top">
                                <a href="/store/cate13/camera" id="banner-interaction">
...
.products .product-category .row .col :link{
    color: #000000;
}
.products .product-category .row .col :visited{
    color: #000000;
}
.products .product-category .row .col :hover{
    text-decoration: none;
    color:#005ba6;
}
.products .product-category .row .col h5{
    font-size: 100%;
    font-weight: bold;
}
.products .product-category .row .col p{
    font-size: 90%;
}
.products .product-category .row .col img{
    width: 7em;
    display: block;
    margin-left: auto;
    margin-right: auto;
