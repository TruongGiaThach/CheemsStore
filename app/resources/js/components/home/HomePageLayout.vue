          ...
          <div class="col-sm-5">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li class="mr-sm-4">
                  <a href="tel:0969694200"
                    ><i class="fa fa-phone mr-sm-2 fa-2x"></i>
                    <p id="info">0969694200</p>
                    <p id="title " class="mr-sm-1">Hotline:</p>
                  </a>
                </li>
                <li class="mr-sm-4">
                  <a href="mailto:admin@devtest.com"
                    ><i class="fa fa-envelope mr-sm-2 fa-2x"></i>
          ...
          <div class="col-sm-2 ml-auto">
            <div class="social-icons pull-right">
              <ul class="nav nav-pills">
                <li>
                  <a
                    href="https://www.facebook.com/cheemsburger/"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://twitter.com/TheCheemsToken?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"
                    target="_blank"
      ...
      <div class="container">
          ...
          <a href="/home" class="navbar-brand">
            <div>
              <img
                id="logo"
                :src="
                  require('../../../../public/images/CheemsIcons.png').default
                "
                width="55em"
              />
              <h2 id="title">
        ...
        <div class="navbar-nav mr-auto">
          <div class="mobile-menu">
            <v-btn id="button" @click="dialog = true" outlined color="red">
          ...
          <form
            ...
            :action="'/store/' + this.category + '/' + this.search"
            method="get"
          >
            <input
...
>>>>>>> 225f63aa15a1acfa0166a8676526b40a8006b76a
                </div>
              </a>
            </div>
          </div>
    ...
    <footer>
          ...
          <div class="row mx-md-n5">
            <div class="col px-md-5">
              ...
              <p>
                ...
                <b>Văn phòng điều hành miền Bắc:</b>
                <br />
                - Tầng 6, Số 1 Phố Thái Hà, Phường Trung Liệt, Quận Đống Đa, Hà
                Nội
                <br />
                <b>Văn phòng điều hành miền Nam:</b>
                <br />
                - Tầng 11 Minh Long Tower, số 17 Bà Huyện Thanh Quan, Phường Võ
            ...
            <div class="col px-md-5">
              <h5 id="title">Liên hệ</h5>
              <p>
                <a class="row" href="tel:0969694200"
                  ><i class="fa fa-phone mr-sm-2 fa-lg"></i>
                  <p id="title" class="mr-sm-1">Tổng đài:</p>
                  <p id="info">0969694200</p>
                </a>
                <a class="row" href="mailto:admin@devtest.com"
                  ><i class="fa fa-envelope mr-sm-2 fa-2x"></i>
                  <p id="title" class="mr-sm-1">Email:</p>
                  <p id="info">admin@devtest.com</p>
                </a>
      ...
      <div class="bottom-footer">
        <router-link :to="{ name: 'home' }" id="right-reserved"
          >2021 © by Cheemsstore.com All Right Reserved.</router-link
        >
      </div>
    </footer>
  </div>
